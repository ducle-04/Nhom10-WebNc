...
export const destinationsData = [
    {
        ...
        badge: 'Hot',
        description: 'Khám phá Sapa – nơi núi rừng hùng vĩ hòa quyện cùng văn hóa đặc sắc, với ruộng bậc thang, đỉnh Fansipan, bản làng truyền thống và ẩm thực độc đáo, là hành trình lý tưởng để trốn khỏi phố thị và hòa mình vào thiên nhiên nguyên sơ. Đặt tour ngay để trải nghiệm!',
        price: '2.500.000đ',
        detailedDescription: 'Sapa là một thị trấn nhỏ nằm ở tỉnh Lào Cai...',
    ...
    },
    {
        ...
        badge: 'New',
        description: 'Phú Quốc – thiên đường biển đảo nổi tiếng với bãi cát trắng trải dài mịn màng, làn nước biển trong xanh như ngọc bích, cùng nguồn hải sản tươi ngon đa dạng, nơi bạn có thể tận hưởng kỳ nghỉ thư giãn tuyệt vời, khám phá thiên nhiên hoang sơ và văn hóa địa phương đặc sắc. Đặt tour ngay để trải nghiệm!',
        price: '3.200.000đ',
        detailedDescription: 'Phú Quốc, hòn đảo lớn nhất Việt Nam...',
    ...
    },
    {
        ...
        badge: 'Best',
        description: 'Đà Lạt – thành phố ngàn hoa rực rỡ với khí hậu mát mẻ quanh năm, nơi lý tưởng để tận hưởng không gian lãng mạn, khám phá những đồi thông xanh ngát, hồ nước trong veo và thưởng thức ẩm thực độc đáo giữa khung cảnh thơ mộng.  Đặt tour ngay để trải nghiệm!',
        price: '2.800.000đ',
        detailedDescription: 'Được mệnh danh là Thiên đường du lịch, Đà Lạt là điểm đến lý tưởng của biết bao du khách. Nơi đây có khí hậu mát mẻ, xứ sở của các loài hoa đua sắc',
